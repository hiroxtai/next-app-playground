...
export default function JotaiBasicsPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      {/* 背景グラデーション */}
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-cyan-100/40 via-transparent to-cyan-200/30 dark:from-cyan-900/20 dark:to-cyan-800/10" />
